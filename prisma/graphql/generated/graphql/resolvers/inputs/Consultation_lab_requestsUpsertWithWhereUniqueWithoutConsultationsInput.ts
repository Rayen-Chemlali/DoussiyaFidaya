...
@TypeGraphQL.InputType("Consultation_lab_requestsUpsertWithWhereUniqueWithoutConsultationsInput", {})
export class Consultation_lab_requestsUpsertWithWhereUniqueWithoutConsultationsInput {
  ...
  update!: Consultation_lab_requestsUpdateWithoutConsultationsInput;
