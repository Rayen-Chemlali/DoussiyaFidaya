...
const crudResolversMap = {
  ...
  Consultation_lab_requests: crudResolvers.Consultation_lab_requestsCrudResolver,
  Consultations: crudResolvers.ConsultationsCrudResolver,
  Ctscan_results: crudResolvers.Ctscan_resultsCrudResolver,
  Doctor_instituts: crudResolvers.Doctor_institutsCrudResolver,
  Doctors: crudResolvers.DoctorsCrudResolver,
  Hopitaux: crudResolvers.HopitauxCrudResolver,
  ...
  Verification_tokens: crudResolvers.Verification_tokensCrudResolver,
  Message: crudResolvers.MessageCrudResolver,
  MessageAttachment: crudResolvers.MessageAttachmentCrudResolver
};
const actionResolversMap = {
  ...
  Consultation_lab_requests: {
    aggregateConsultation_lab_requests: actionResolvers.AggregateConsultation_lab_requestsResolver,
    createManyConsultation_lab_requests: actionResolvers.CreateManyConsultation_lab_requestsResolver,
    createManyAndReturnConsultation_lab_requests: actionResolvers.CreateManyAndReturnConsultation_lab_requestsResolver,
    createOneConsultation_lab_requests: actionResolvers.CreateOneConsultation_lab_requestsResolver,
    deleteManyConsultation_lab_requests: actionResolvers.DeleteManyConsultation_lab_requestsResolver,
    deleteOneConsultation_lab_requests: actionResolvers.DeleteOneConsultation_lab_requestsResolver,
    findFirstConsultation_lab_requests: actionResolvers.FindFirstConsultation_lab_requestsResolver,
    findFirstConsultation_lab_requestsOrThrow: actionResolvers.FindFirstConsultation_lab_requestsOrThrowResolver,
    findManyConsultation_lab_requests: actionResolvers.FindManyConsultation_lab_requestsResolver,
    findUniqueConsultation_lab_requests: actionResolvers.FindUniqueConsultation_lab_requestsResolver,
    findUniqueConsultation_lab_requestsOrThrow: actionResolvers.FindUniqueConsultation_lab_requestsOrThrowResolver,
    groupByConsultation_lab_requests: actionResolvers.GroupByConsultation_lab_requestsResolver,
    updateManyConsultation_lab_requests: actionResolvers.UpdateManyConsultation_lab_requestsResolver,
    updateOneConsultation_lab_requests: actionResolvers.UpdateOneConsultation_lab_requestsResolver,
    upsertOneConsultation_lab_requests: actionResolvers.UpsertOneConsultation_lab_requestsResolver
  },
  Consultations: {
  ...
  Doctor_instituts: {
    aggregateDoctor_instituts: actionResolvers.AggregateDoctor_institutsResolver,
    createManyDoctor_instituts: actionResolvers.CreateManyDoctor_institutsResolver,
    createManyAndReturnDoctor_instituts: actionResolvers.CreateManyAndReturnDoctor_institutsResolver,
    createOneDoctor_instituts: actionResolvers.CreateOneDoctor_institutsResolver,
    deleteManyDoctor_instituts: actionResolvers.DeleteManyDoctor_institutsResolver,
    deleteOneDoctor_instituts: actionResolvers.DeleteOneDoctor_institutsResolver,
    findFirstDoctor_instituts: actionResolvers.FindFirstDoctor_institutsResolver,
    findFirstDoctor_institutsOrThrow: actionResolvers.FindFirstDoctor_institutsOrThrowResolver,
    findManyDoctor_instituts: actionResolvers.FindManyDoctor_institutsResolver,
    findUniqueDoctor_instituts: actionResolvers.FindUniqueDoctor_institutsResolver,
    findUniqueDoctor_institutsOrThrow: actionResolvers.FindUniqueDoctor_institutsOrThrowResolver,
    groupByDoctor_instituts: actionResolvers.GroupByDoctor_institutsResolver,
    updateManyDoctor_instituts: actionResolvers.UpdateManyDoctor_institutsResolver,
    updateOneDoctor_instituts: actionResolvers.UpdateOneDoctor_institutsResolver,
    upsertOneDoctor_instituts: actionResolvers.UpsertOneDoctor_institutsResolver
  },
  Doctors: {
  ...
  Hopitaux: {
    aggregateHopitaux: actionResolvers.AggregateHopitauxResolver,
    createManyHopitaux: actionResolvers.CreateManyHopitauxResolver,
    createManyAndReturnHopitaux: actionResolvers.CreateManyAndReturnHopitauxResolver,
    createOneHopitaux: actionResolvers.CreateOneHopitauxResolver,
    deleteManyHopitaux: actionResolvers.DeleteManyHopitauxResolver,
    deleteOneHopitaux: actionResolvers.DeleteOneHopitauxResolver,
    findFirstHopitaux: actionResolvers.FindFirstHopitauxResolver,
    findFirstHopitauxOrThrow: actionResolvers.FindFirstHopitauxOrThrowResolver,
    hopitauxes: actionResolvers.FindManyHopitauxResolver,
    hopitaux: actionResolvers.FindUniqueHopitauxResolver,
    getHopitaux: actionResolvers.FindUniqueHopitauxOrThrowResolver,
    groupByHopitaux: actionResolvers.GroupByHopitauxResolver,
    updateManyHopitaux: actionResolvers.UpdateManyHopitauxResolver,
    updateOneHopitaux: actionResolvers.UpdateOneHopitauxResolver,
    upsertOneHopitaux: actionResolvers.UpsertOneHopitauxResolver
  },
  Instituts_medicaux: {
  ...
  Verification_tokens: {
    aggregateVerification_tokens: actionResolvers.AggregateVerification_tokensResolver,
    createManyVerification_tokens: actionResolvers.CreateManyVerification_tokensResolver,
    createManyAndReturnVerification_tokens: actionResolvers.CreateManyAndReturnVerification_tokensResolver,
    createOneVerification_tokens: actionResolvers.CreateOneVerification_tokensResolver,
    deleteManyVerification_tokens: actionResolvers.DeleteManyVerification_tokensResolver,
    deleteOneVerification_tokens: actionResolvers.DeleteOneVerification_tokensResolver,
    findFirstVerification_tokens: actionResolvers.FindFirstVerification_tokensResolver,
    findFirstVerification_tokensOrThrow: actionResolvers.FindFirstVerification_tokensOrThrowResolver,
    findManyVerification_tokens: actionResolvers.FindManyVerification_tokensResolver,
    findUniqueVerification_tokens: actionResolvers.FindUniqueVerification_tokensResolver,
    findUniqueVerification_tokensOrThrow: actionResolvers.FindUniqueVerification_tokensOrThrowResolver,
    groupByVerification_tokens: actionResolvers.GroupByVerification_tokensResolver,
    updateManyVerification_tokens: actionResolvers.UpdateManyVerification_tokensResolver,
    updateOneVerification_tokens: actionResolvers.UpdateOneVerification_tokensResolver,
    upsertOneVerification_tokens: actionResolvers.UpsertOneVerification_tokensResolver
  },
  Message: {
    aggregateMessage: actionResolvers.AggregateMessageResolver,
    createManyMessage: actionResolvers.CreateManyMessageResolver,
    createManyAndReturnMessage: actionResolvers.CreateManyAndReturnMessageResolver,
  ...
  MessageAttachment: {
    aggregateMessageAttachment: actionResolvers.AggregateMessageAttachmentResolver,
    createManyMessageAttachment: actionResolvers.CreateManyMessageAttachmentResolver,
    createManyAndReturnMessageAttachment: actionResolvers.CreateManyAndReturnMessageAttachmentResolver,
    createOneMessageAttachment: actionResolvers.CreateOneMessageAttachmentResolver,
    deleteManyMessageAttachment: actionResolvers.DeleteManyMessageAttachmentResolver,
    deleteOneMessageAttachment: actionResolvers.DeleteOneMessageAttachmentResolver,
    findFirstMessageAttachment: actionResolvers.FindFirstMessageAttachmentResolver,
    findFirstMessageAttachmentOrThrow: actionResolvers.FindFirstMessageAttachmentOrThrowResolver,
    messageAttachments: actionResolvers.FindManyMessageAttachmentResolver,
    messageAttachment: actionResolvers.FindUniqueMessageAttachmentResolver,
    getMessageAttachment: actionResolvers.FindUniqueMessageAttachmentOrThrowResolver,
    groupByMessageAttachment: actionResolvers.GroupByMessageAttachmentResolver,
    updateManyMessageAttachment: actionResolvers.UpdateManyMessageAttachmentResolver,
    updateOneMessageAttachment: actionResolvers.UpdateOneMessageAttachmentResolver,
    upsertOneMessageAttachment: actionResolvers.UpsertOneMessageAttachmentResolver
  }
};
const crudResolversInfo = {
  ...
  Consultation_lab_requests: ["aggregateConsultation_lab_requests", "createManyConsultation_lab_requests", "createManyAndReturnConsultation_lab_requests", "createOneConsultation_lab_requests", "deleteManyConsultation_lab_requests", "deleteOneConsultation_lab_requests", "findFirstConsultation_lab_requests", "findFirstConsultation_lab_requestsOrThrow", "findManyConsultation_lab_requests", "findUniqueConsultation_lab_requests", "findUniqueConsultation_lab_requestsOrThrow", "groupByConsultation_lab_requests", "updateManyConsultation_lab_requests", "updateOneConsultation_lab_requests", "upsertOneConsultation_lab_requests"],
  ...
  Doctor_instituts: ["aggregateDoctor_instituts", "createManyDoctor_instituts", "createManyAndReturnDoctor_instituts", "createOneDoctor_instituts", "deleteManyDoctor_instituts", "deleteOneDoctor_instituts", "findFirstDoctor_instituts", "findFirstDoctor_institutsOrThrow", "findManyDoctor_instituts", "findUniqueDoctor_instituts", "findUniqueDoctor_institutsOrThrow", "groupByDoctor_instituts", "updateManyDoctor_instituts", "updateOneDoctor_instituts", "upsertOneDoctor_instituts"],
  ...
  Hopitaux: ["aggregateHopitaux", "createManyHopitaux", "createManyAndReturnHopitaux", "createOneHopitaux", "deleteManyHopitaux", "deleteOneHopitaux", "findFirstHopitaux", "findFirstHopitauxOrThrow", "hopitauxes", "hopitaux", "getHopitaux", "groupByHopitaux", "updateManyHopitaux", "updateOneHopitaux", "upsertOneHopitaux"],
  ...
  Verification_tokens: ["aggregateVerification_tokens", "createManyVerification_tokens", "createManyAndReturnVerification_tokens", "createOneVerification_tokens", "deleteManyVerification_tokens", "deleteOneVerification_tokens", "findFirstVerification_tokens", "findFirstVerification_tokensOrThrow", "findManyVerification_tokens", "findUniqueVerification_tokens", "findUniqueVerification_tokensOrThrow", "groupByVerification_tokens", "updateManyVerification_tokens", "updateOneVerification_tokens", "upsertOneVerification_tokens"],
  Message: ["aggregateMessage", "createManyMessage", "createManyAndReturnMessage", "createOneMessage", "deleteManyMessage", "deleteOneMessage", "findFirstMessage", "findFirstMessageOrThrow", "messages", "message", "getMessage", "groupByMessage", "updateManyMessage", "updateOneMessage", "upsertOneMessage"],
  MessageAttachment: ["aggregateMessageAttachment", "createManyMessageAttachment", "createManyAndReturnMessageAttachment", "createOneMessageAttachment", "deleteManyMessageAttachment", "deleteOneMessageAttachment", "findFirstMessageAttachment", "findFirstMessageAttachmentOrThrow", "messageAttachments", "messageAttachment", "getMessageAttachment", "groupByMessageAttachment", "updateManyMessageAttachment", "updateOneMessageAttachment", "upsertOneMessageAttachment"]
};
const argsInfo = {
  ...
  AggregateConsultation_lab_requestsArgs: ["where", "orderBy", "cursor", "take", "skip"],
  CreateManyConsultation_lab_requestsArgs: ["data", "skipDuplicates"],
  CreateManyAndReturnConsultation_lab_requestsArgs: ["data", "skipDuplicates"],
  CreateOneConsultation_lab_requestsArgs: ["data"],
  DeleteManyConsultation_lab_requestsArgs: ["where"],
  DeleteOneConsultation_lab_requestsArgs: ["where"],
  FindFirstConsultation_lab_requestsArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindFirstConsultation_lab_requestsOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyConsultation_lab_requestsArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindUniqueConsultation_lab_requestsArgs: ["where"],
  FindUniqueConsultation_lab_requestsOrThrowArgs: ["where"],
  GroupByConsultation_lab_requestsArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  UpdateManyConsultation_lab_requestsArgs: ["data", "where"],
  UpdateOneConsultation_lab_requestsArgs: ["data", "where"],
  UpsertOneConsultation_lab_requestsArgs: ["where", "create", "update"],
  ...
  AggregateDoctor_institutsArgs: ["where", "orderBy", "cursor", "take", "skip"],
  CreateManyDoctor_institutsArgs: ["data", "skipDuplicates"],
  CreateManyAndReturnDoctor_institutsArgs: ["data", "skipDuplicates"],
  CreateOneDoctor_institutsArgs: ["data"],
  DeleteManyDoctor_institutsArgs: ["where"],
  DeleteOneDoctor_institutsArgs: ["where"],
  FindFirstDoctor_institutsArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindFirstDoctor_institutsOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyDoctor_institutsArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindUniqueDoctor_institutsArgs: ["where"],
  FindUniqueDoctor_institutsOrThrowArgs: ["where"],
  GroupByDoctor_institutsArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  UpdateManyDoctor_institutsArgs: ["data", "where"],
  UpdateOneDoctor_institutsArgs: ["data", "where"],
  UpsertOneDoctor_institutsArgs: ["where", "create", "update"],
  ...
  AggregateHopitauxArgs: ["where", "orderBy", "cursor", "take", "skip"],
  CreateManyHopitauxArgs: ["data", "skipDuplicates"],
  CreateManyAndReturnHopitauxArgs: ["data", "skipDuplicates"],
  CreateOneHopitauxArgs: ["data"],
  DeleteManyHopitauxArgs: ["where"],
  DeleteOneHopitauxArgs: ["where"],
  FindFirstHopitauxArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindFirstHopitauxOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyHopitauxArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindUniqueHopitauxArgs: ["where"],
  FindUniqueHopitauxOrThrowArgs: ["where"],
  GroupByHopitauxArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  UpdateManyHopitauxArgs: ["data", "where"],
  UpdateOneHopitauxArgs: ["data", "where"],
  UpsertOneHopitauxArgs: ["where", "create", "update"],
  ...
  AggregateVerification_tokensArgs: ["where", "orderBy", "cursor", "take", "skip"],
  CreateManyVerification_tokensArgs: ["data", "skipDuplicates"],
  CreateManyAndReturnVerification_tokensArgs: ["data", "skipDuplicates"],
  CreateOneVerification_tokensArgs: ["data"],
  DeleteManyVerification_tokensArgs: ["where"],
  DeleteOneVerification_tokensArgs: ["where"],
  FindFirstVerification_tokensArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindFirstVerification_tokensOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyVerification_tokensArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindUniqueVerification_tokensArgs: ["where"],
  FindUniqueVerification_tokensOrThrowArgs: ["where"],
  GroupByVerification_tokensArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  UpdateManyVerification_tokensArgs: ["data", "where"],
  UpdateOneVerification_tokensArgs: ["data", "where"],
  UpsertOneVerification_tokensArgs: ["where", "create", "update"],
  AggregateMessageArgs: ["where", "orderBy", "cursor", "take", "skip"],
  CreateManyMessageArgs: ["data", "skipDuplicates"],
  CreateManyAndReturnMessageArgs: ["data", "skipDuplicates"],
  ...
  AggregateMessageAttachmentArgs: ["where", "orderBy", "cursor", "take", "skip"],
  CreateManyMessageAttachmentArgs: ["data", "skipDuplicates"],
  CreateManyAndReturnMessageAttachmentArgs: ["data", "skipDuplicates"],
  CreateOneMessageAttachmentArgs: ["data"],
  DeleteManyMessageAttachmentArgs: ["where"],
  DeleteOneMessageAttachmentArgs: ["where"],
  FindFirstMessageAttachmentArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindFirstMessageAttachmentOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyMessageAttachmentArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindUniqueMessageAttachmentArgs: ["where"],
  FindUniqueMessageAttachmentOrThrowArgs: ["where"],
  GroupByMessageAttachmentArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  UpdateManyMessageAttachmentArgs: ["data", "where"],
  UpdateOneMessageAttachmentArgs: ["data", "where"],
  UpsertOneMessageAttachmentArgs: ["where", "create", "update"]
};
...
const relationResolversMap = {
  ...
  Consultation_lab_requests: relationResolvers.Consultation_lab_requestsRelationsResolver,
  ...
  Doctor_instituts: relationResolvers.Doctor_institutsRelationsResolver,
  ...
  Verification_tokens: relationResolvers.Verification_tokensRelationsResolver,
  Message: relationResolvers.MessageRelationsResolver,
  MessageAttachment: relationResolvers.MessageAttachmentRelationsResolver
};
const relationResolversInfo = {
  ...
  Consultation_lab_requests: ["lab_requests", "consultations"],
  Consultations: ["consultation_lab_requests", "prescriptions", "instituts_medicaux", "patients", "doctors", "rdvs", "lab_requests"],
  Ctscan_results: ["lab_documents"],
  Doctor_instituts: ["doctors", "instituts_medicaux"],
  Doctors: ["certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  Instituts_medicaux: ["authorizations", "consultations", "doctor_instituts", "doctors"],
  ...
  Lab_requests: ["consultation_lab_requests", "lab_documents", "doctors", "patients", "consultations"],
  ...
  Users: ["validation_token", "doctors", "patients"],
  Xray_results: ["lab_documents"],
  Verification_tokens: ["user"],
  Message: ["sender", "receiver", "attachments"],
...
const modelsInfo = {
  ...
  Consultation_lab_requests: ["consultation_id", "lab_request_id"],
  ...
  Doctor_instituts: ["doctor_id", "institut_medical_id"],
  Doctors: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "user_id"],
  Hopitaux: ["id", "type", "name", "address", "phone", "email"],
  ...
  Users: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at"],
  Xray_results: ["id", "is_abnormal", "description", "title", "result_type", "lab_document_id"],
  Verification_tokens: ["id", "userId", "token", "numberofTries", "createdAt", "expireAt"],
  Message: ["id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId"],
  MessageAttachment: ["id", "filename", "path", "mimeType", "size", "messageId", "createdAt"]
};
...
const outputsInfo = {
  ...
  AggregateConsultation_lab_requests: ["_count", "_min", "_max"],
  Consultation_lab_requestsGroupBy: ["consultation_id", "lab_request_id", "_count", "_min", "_max"],
  ...
  AggregateDoctor_instituts: ["_count", "_min", "_max"],
  Doctor_institutsGroupBy: ["doctor_id", "institut_medical_id", "_count", "_min", "_max"],
  AggregateDoctors: ["_count", "_min", "_max"],
  DoctorsGroupBy: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "user_id", "_count", "_min", "_max"],
  AggregateHopitaux: ["_count", "_min", "_max"],
  HopitauxGroupBy: ["id", "type", "name", "address", "phone", "email", "_count", "_min", "_max"],
  ...
  UsersGroupBy: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "_count", "_min", "_max"],
  ...
  AggregateVerification_tokens: ["_count", "_avg", "_sum", "_min", "_max"],
  Verification_tokensGroupBy: ["id", "userId", "token", "numberofTries", "createdAt", "expireAt", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateMessage: ["_count", "_min", "_max"],
  MessageGroupBy: ["id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId", "_count", "_min", "_max"],
  AggregateMessageAttachment: ["_count", "_avg", "_sum", "_min", "_max"],
  MessageAttachmentGroupBy: ["id", "filename", "path", "mimeType", "size", "messageId", "createdAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  Consultation_lab_requestsCountAggregate: ["consultation_id", "lab_request_id", "_all"],
  Consultation_lab_requestsMinAggregate: ["consultation_id", "lab_request_id"],
  Consultation_lab_requestsMaxAggregate: ["consultation_id", "lab_request_id"],
  ConsultationsCount: ["consultation_lab_requests", "lab_requests"],
  ...
  Doctor_institutsCountAggregate: ["doctor_id", "institut_medical_id", "_all"],
  Doctor_institutsMinAggregate: ["doctor_id", "institut_medical_id"],
  Doctor_institutsMaxAggregate: ["doctor_id", "institut_medical_id"],
  DoctorsCount: ["certificates", "consultations", "doctor_instituts", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  DoctorsCountAggregate: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "user_id", "_all"],
  DoctorsMinAggregate: ["id", "type", "is_license_verified", "bio", "first_name", "last_name", "profile_image", "specialty", "user_id"],
  DoctorsMaxAggregate: ["id", "type", "is_license_verified", "bio", "first_name", "last_name", "profile_image", "specialty", "user_id"],
  HopitauxCountAggregate: ["id", "type", "name", "address", "phone", "email", "_all"],
  HopitauxMinAggregate: ["id", "type", "name", "address", "phone", "email"],
  HopitauxMaxAggregate: ["id", "type", "name", "address", "phone", "email"],
  Instituts_medicauxCount: ["authorizations", "consultations", "doctor_instituts", "doctors"],
  ...
  Lab_requestsCount: ["consultation_lab_requests", "lab_documents", "consultations"],
  ...
  PrescriptionsCount: ["consultations", "medications"],
  ...
  UsersCount: ["doctors", "patients"],
  UsersCountAggregate: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "_all"],
  UsersMinAggregate: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at"],
  UsersMaxAggregate: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at"],
  ...
  Verification_tokensCountAggregate: ["id", "userId", "token", "numberofTries", "createdAt", "expireAt", "_all"],
  Verification_tokensAvgAggregate: ["numberofTries"],
  Verification_tokensSumAggregate: ["numberofTries"],
  Verification_tokensMinAggregate: ["id", "userId", "token", "numberofTries", "createdAt", "expireAt"],
  Verification_tokensMaxAggregate: ["id", "userId", "token", "numberofTries", "createdAt", "expireAt"],
  MessageCount: ["attachments"],
  MessageCountAggregate: ["id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId", "_all"],
  MessageMinAggregate: ["id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId"],
  MessageMaxAggregate: ["id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId"],
  MessageAttachmentCountAggregate: ["id", "filename", "path", "mimeType", "size", "messageId", "createdAt", "_all"],
  MessageAttachmentAvgAggregate: ["size"],
  MessageAttachmentSumAggregate: ["size"],
  MessageAttachmentMinAggregate: ["id", "filename", "path", "mimeType", "size", "messageId", "createdAt"],
  MessageAttachmentMaxAggregate: ["id", "filename", "path", "mimeType", "size", "messageId", "createdAt"],
  ...
  CreateManyAndReturnConsultation_lab_requests: ["consultation_id", "lab_request_id", "lab_requests", "consultations"],
  ...
  CreateManyAndReturnDoctor_instituts: ["doctor_id", "institut_medical_id", "doctors", "instituts_medicaux"],
  CreateManyAndReturnDoctors: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "user_id", "users"],
  CreateManyAndReturnHopitaux: ["id", "type", "name", "address", "phone", "email"],
  ...
  CreateManyAndReturnUsers: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at"],
  CreateManyAndReturnXray_results: ["id", "is_abnormal", "description", "title", "result_type", "lab_document_id", "lab_documents"],
  CreateManyAndReturnVerification_tokens: ["id", "userId", "token", "numberofTries", "createdAt", "expireAt", "user"],
  CreateManyAndReturnMessage: ["id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId", "sender", "receiver"],
  CreateManyAndReturnMessageAttachment: ["id", "filename", "path", "mimeType", "size", "messageId", "createdAt", "message"]
};
...
const inputsInfo = {
  ...
  Consultation_lab_requestsWhereInput: ["AND", "OR", "NOT", "consultation_id", "lab_request_id", "lab_requests", "consultations"],
  Consultation_lab_requestsOrderByWithRelationInput: ["consultation_id", "lab_request_id", "lab_requests", "consultations"],
  Consultation_lab_requestsWhereUniqueInput: ["consultation_id_lab_request_id", "AND", "OR", "NOT", "consultation_id", "lab_request_id", "lab_requests", "consultations"],
  Consultation_lab_requestsOrderByWithAggregationInput: ["consultation_id", "lab_request_id", "_count", "_max", "_min"],
  Consultation_lab_requestsScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "consultation_id", "lab_request_id"],
  ConsultationsWhereInput: ["AND", "OR", "NOT", "id", "section", "date", "notes", "measures", "doctor_id", "institut_medical_id", "prescription_id", "patient_id", "consultation_lab_requests", "prescriptions", "instituts_medicaux", "patients", "doctors", "rdvs", "lab_requests"],
  ConsultationsOrderByWithRelationInput: ["id", "section", "date", "notes", "measures", "doctor_id", "institut_medical_id", "prescription_id", "patient_id", "consultation_lab_requests", "prescriptions", "instituts_medicaux", "patients", "doctors", "rdvs", "lab_requests"],
  ConsultationsWhereUniqueInput: ["id", "prescription_id", "AND", "OR", "NOT", "section", "date", "notes", "measures", "doctor_id", "institut_medical_id", "patient_id", "consultation_lab_requests", "prescriptions", "instituts_medicaux", "patients", "doctors", "rdvs", "lab_requests"],
  ...
  Doctor_institutsWhereInput: ["AND", "OR", "NOT", "doctor_id", "institut_medical_id", "doctors", "instituts_medicaux"],
  Doctor_institutsOrderByWithRelationInput: ["doctor_id", "institut_medical_id", "doctors", "instituts_medicaux"],
  Doctor_institutsWhereUniqueInput: ["doctor_id_institut_medical_id", "AND", "OR", "NOT", "doctor_id", "institut_medical_id", "doctors", "instituts_medicaux"],
  Doctor_institutsOrderByWithAggregationInput: ["doctor_id", "institut_medical_id", "_count", "_max", "_min"],
  Doctor_institutsScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "doctor_id", "institut_medical_id"],
  DoctorsWhereInput: ["AND", "OR", "NOT", "id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "user_id", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  DoctorsOrderByWithRelationInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "user_id", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  DoctorsWhereUniqueInput: ["id", "user_id", "AND", "OR", "NOT", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  DoctorsOrderByWithAggregationInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "user_id", "_count", "_max", "_min"],
  DoctorsScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "user_id"],
  HopitauxWhereInput: ["AND", "OR", "NOT", "id", "type", "name", "address", "phone", "email"],
  HopitauxOrderByWithRelationInput: ["id", "type", "name", "address", "phone", "email"],
  HopitauxWhereUniqueInput: ["id", "AND", "OR", "NOT", "type", "name", "address", "phone", "email"],
  HopitauxOrderByWithAggregationInput: ["id", "type", "name", "address", "phone", "email", "_count", "_max", "_min"],
  HopitauxScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "type", "name", "address", "phone", "email"],
  Instituts_medicauxWhereInput: ["AND", "OR", "NOT", "id", "type", "authorizations", "consultations", "doctor_instituts", "doctors"],
  Instituts_medicauxOrderByWithRelationInput: ["id", "type", "authorizations", "consultations", "doctor_instituts", "doctors"],
  Instituts_medicauxWhereUniqueInput: ["id", "AND", "OR", "NOT", "type", "authorizations", "consultations", "doctor_instituts", "doctors"],
  ...
  Lab_requestsWhereInput: ["AND", "OR", "NOT", "id", "type", "priority", "description", "doctor_id", "patient_id", "consultation_lab_requests", "lab_documents", "doctors", "patients", "consultations"],
  Lab_requestsOrderByWithRelationInput: ["id", "type", "priority", "description", "doctor_id", "patient_id", "consultation_lab_requests", "lab_documents", "doctors", "patients", "consultations"],
  Lab_requestsWhereUniqueInput: ["id", "AND", "OR", "NOT", "type", "priority", "description", "doctor_id", "patient_id", "consultation_lab_requests", "lab_documents", "doctors", "patients", "consultations"],
  ...
  UsersWhereInput: ["AND", "OR", "NOT", "id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "validation_token", "doctors", "patients"],
  UsersOrderByWithRelationInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "validation_token", "doctors", "patients"],
  UsersWhereUniqueInput: ["id", "email", "AND", "OR", "NOT", "address", "created_at", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "validation_token", "doctors", "patients"],
  UsersOrderByWithAggregationInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "_count", "_max", "_min"],
  UsersScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at"],
  ...
  Verification_tokensWhereInput: ["AND", "OR", "NOT", "id", "userId", "token", "numberofTries", "createdAt", "expireAt", "user"],
  Verification_tokensOrderByWithRelationInput: ["id", "userId", "token", "numberofTries", "createdAt", "expireAt", "user"],
  Verification_tokensWhereUniqueInput: ["id", "userId", "AND", "OR", "NOT", "token", "numberofTries", "createdAt", "expireAt", "user"],
  Verification_tokensOrderByWithAggregationInput: ["id", "userId", "token", "numberofTries", "createdAt", "expireAt", "_count", "_avg", "_max", "_min", "_sum"],
  Verification_tokensScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "userId", "token", "numberofTries", "createdAt", "expireAt"],
  MessageWhereInput: ["AND", "OR", "NOT", "id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId", "sender", "receiver", "attachments"],
  MessageOrderByWithRelationInput: ["id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId", "sender", "receiver", "attachments"],
  MessageWhereUniqueInput: ["id", "AND", "OR", "NOT", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId", "sender", "receiver", "attachments"],
  MessageOrderByWithAggregationInput: ["id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId", "_count", "_max", "_min"],
  MessageScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId"],
  MessageAttachmentWhereInput: ["AND", "OR", "NOT", "id", "filename", "path", "mimeType", "size", "messageId", "createdAt", "message"],
  MessageAttachmentOrderByWithRelationInput: ["id", "filename", "path", "mimeType", "size", "messageId", "createdAt", "message"],
  MessageAttachmentWhereUniqueInput: ["id", "AND", "OR", "NOT", "filename", "path", "mimeType", "size", "messageId", "createdAt", "message"],
  MessageAttachmentOrderByWithAggregationInput: ["id", "filename", "path", "mimeType", "size", "messageId", "createdAt", "_count", "_avg", "_max", "_min", "_sum"],
  MessageAttachmentScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "filename", "path", "mimeType", "size", "messageId", "createdAt"],
  ...
  Consultation_lab_requestsCreateInput: ["lab_requests", "consultations"],
  Consultation_lab_requestsUpdateInput: ["lab_requests", "consultations"],
  Consultation_lab_requestsCreateManyInput: ["consultation_id", "lab_request_id"],
  Consultation_lab_requestsUpdateManyMutationInput: [],
  ConsultationsCreateInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "prescriptions", "instituts_medicaux", "patients", "doctors", "rdvs", "lab_requests"],
  ConsultationsUpdateInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "prescriptions", "instituts_medicaux", "patients", "doctors", "rdvs", "lab_requests"],
  ...
  Doctor_institutsCreateInput: ["doctors", "instituts_medicaux"],
  Doctor_institutsUpdateInput: ["doctors", "instituts_medicaux"],
  Doctor_institutsCreateManyInput: ["doctor_id", "institut_medical_id"],
  Doctor_institutsUpdateManyMutationInput: [],
  DoctorsCreateInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  DoctorsUpdateInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  DoctorsCreateManyInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "user_id"],
  DoctorsUpdateManyMutationInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty"],
  HopitauxCreateInput: ["id", "type", "name", "address", "phone", "email"],
  HopitauxUpdateInput: ["id", "type", "name", "address", "phone", "email"],
  HopitauxCreateManyInput: ["id", "type", "name", "address", "phone", "email"],
  HopitauxUpdateManyMutationInput: ["id", "type", "name", "address", "phone", "email"],
  Instituts_medicauxCreateInput: ["id", "type", "authorizations", "consultations", "doctor_instituts", "doctors"],
  Instituts_medicauxUpdateInput: ["id", "type", "authorizations", "consultations", "doctor_instituts", "doctors"],
  ...
  Lab_requestsCreateInput: ["id", "type", "priority", "description", "consultation_lab_requests", "lab_documents", "doctors", "patients", "consultations"],
  Lab_requestsUpdateInput: ["id", "type", "priority", "description", "consultation_lab_requests", "lab_documents", "doctors", "patients", "consultations"],
  ...
  UsersCreateInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "validation_token", "doctors", "patients"],
  UsersUpdateInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "validation_token", "doctors", "patients"],
  UsersCreateManyInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at"],
  UsersUpdateManyMutationInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at"],
  ...
  Verification_tokensCreateInput: ["id", "token", "numberofTries", "createdAt", "expireAt", "user"],
  Verification_tokensUpdateInput: ["id", "token", "numberofTries", "createdAt", "expireAt", "user"],
  Verification_tokensCreateManyInput: ["id", "userId", "token", "numberofTries", "createdAt", "expireAt"],
  Verification_tokensUpdateManyMutationInput: ["id", "token", "numberofTries", "createdAt", "expireAt"],
  MessageCreateInput: ["id", "content", "createdAt", "updatedAt", "isRead", "patientId", "sender", "receiver", "attachments"],
  MessageUpdateInput: ["id", "content", "createdAt", "updatedAt", "isRead", "patientId", "sender", "receiver", "attachments"],
  MessageCreateManyInput: ["id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId"],
  MessageUpdateManyMutationInput: ["id", "content", "createdAt", "updatedAt", "isRead", "patientId"],
  MessageAttachmentCreateInput: ["id", "filename", "path", "mimeType", "size", "createdAt", "message"],
  MessageAttachmentUpdateInput: ["id", "filename", "path", "mimeType", "size", "createdAt", "message"],
  MessageAttachmentCreateManyInput: ["id", "filename", "path", "mimeType", "size", "messageId", "createdAt"],
  MessageAttachmentUpdateManyMutationInput: ["id", "filename", "path", "mimeType", "size", "createdAt"],
  ...
  Lab_requestsRelationFilter: ["is", "isNot"],
  ConsultationsRelationFilter: ["is", "isNot"],
  consultation_lab_requestsConsultation_idLab_request_idCompoundUniqueInput: ["consultation_id", "lab_request_id"],
  Consultation_lab_requestsCountOrderByAggregateInput: ["consultation_id", "lab_request_id"],
  Consultation_lab_requestsMaxOrderByAggregateInput: ["consultation_id", "lab_request_id"],
  Consultation_lab_requestsMinOrderByAggregateInput: ["consultation_id", "lab_request_id"],
  ...
  Consultation_lab_requestsListRelationFilter: ["every", "some", "none"],
  ...
  Consultation_lab_requestsOrderByRelationAggregateInput: ["_count"],
  ...
  DoctorsRelationFilter: ["is", "isNot"],
  Instituts_medicauxRelationFilter: ["is", "isNot"],
  doctor_institutsDoctor_idInstitut_medical_idCompoundUniqueInput: ["doctor_id", "institut_medical_id"],
  Doctor_institutsCountOrderByAggregateInput: ["doctor_id", "institut_medical_id"],
  Doctor_institutsMaxOrderByAggregateInput: ["doctor_id", "institut_medical_id"],
  Doctor_institutsMinOrderByAggregateInput: ["doctor_id", "institut_medical_id"],
  ...
  Doctor_institutsListRelationFilter: ["every", "some", "none"],
  ...
  Doctor_institutsOrderByRelationAggregateInput: ["_count"],
  ...
  DoctorsCountOrderByAggregateInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "user_id"],
  DoctorsMaxOrderByAggregateInput: ["id", "type", "is_license_verified", "bio", "first_name", "last_name", "profile_image", "specialty", "user_id"],
  DoctorsMinOrderByAggregateInput: ["id", "type", "is_license_verified", "bio", "first_name", "last_name", "profile_image", "specialty", "user_id"],
  ...
  Enumhopitaux_type_enumFilter: ["equals", "in", "notIn", "not"],
  HopitauxCountOrderByAggregateInput: ["id", "type", "name", "address", "phone", "email"],
  HopitauxMaxOrderByAggregateInput: ["id", "type", "name", "address", "phone", "email"],
  HopitauxMinOrderByAggregateInput: ["id", "type", "name", "address", "phone", "email"],
  Enumhopitaux_type_enumWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  ...
  Verification_tokensNullableRelationFilter: ["is", "isNot"],
  PatientsListRelationFilter: ["every", "some", "none"],
  PatientsOrderByRelationAggregateInput: ["_count"],
  UsersCountOrderByAggregateInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at"],
  UsersMaxOrderByAggregateInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at"],
  UsersMinOrderByAggregateInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at"],
  ...
  Verification_tokensCountOrderByAggregateInput: ["id", "userId", "token", "numberofTries", "createdAt", "expireAt"],
  Verification_tokensAvgOrderByAggregateInput: ["numberofTries"],
  Verification_tokensMaxOrderByAggregateInput: ["id", "userId", "token", "numberofTries", "createdAt", "expireAt"],
  Verification_tokensMinOrderByAggregateInput: ["id", "userId", "token", "numberofTries", "createdAt", "expireAt"],
  Verification_tokensSumOrderByAggregateInput: ["numberofTries"],
  MessageAttachmentListRelationFilter: ["every", "some", "none"],
  MessageAttachmentOrderByRelationAggregateInput: ["_count"],
  MessageCountOrderByAggregateInput: ["id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId"],
  MessageMaxOrderByAggregateInput: ["id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId"],
  MessageMinOrderByAggregateInput: ["id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId"],
  MessageRelationFilter: ["is", "isNot"],
  MessageAttachmentCountOrderByAggregateInput: ["id", "filename", "path", "mimeType", "size", "messageId", "createdAt"],
  MessageAttachmentAvgOrderByAggregateInput: ["size"],
  MessageAttachmentMaxOrderByAggregateInput: ["id", "filename", "path", "mimeType", "size", "messageId", "createdAt"],
  MessageAttachmentMinOrderByAggregateInput: ["id", "filename", "path", "mimeType", "size", "messageId", "createdAt"],
  MessageAttachmentSumOrderByAggregateInput: ["size"],
  ...
  Lab_requestsCreateNestedOneWithoutConsultation_lab_requestsInput: ["create", "connectOrCreate", "connect"],
  ConsultationsCreateNestedOneWithoutConsultation_lab_requestsInput: ["create", "connectOrCreate", "connect"],
  Lab_requestsUpdateOneRequiredWithoutConsultation_lab_requestsNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ConsultationsUpdateOneRequiredWithoutConsultation_lab_requestsNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ConsultationsCreatenotesInput: ["set"],
  Consultation_lab_requestsCreateNestedManyWithoutConsultationsInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  Consultation_lab_requestsUpdateManyWithoutConsultationsNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  DoctorsCreateNestedOneWithoutDoctor_institutsInput: ["create", "connectOrCreate", "connect"],
  Instituts_medicauxCreateNestedOneWithoutDoctor_institutsInput: ["create", "connectOrCreate", "connect"],
  DoctorsUpdateOneRequiredWithoutDoctor_institutsNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  Instituts_medicauxUpdateOneRequiredWithoutDoctor_institutsNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  Doctor_institutsCreateNestedManyWithoutDoctorsInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  MessageCreateNestedManyWithoutReceiverInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  Doctor_institutsUpdateManyWithoutDoctorsNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  MessageUpdateManyWithoutReceiverNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  Enumhopitaux_type_enumFieldUpdateOperationsInput: ["set"],
  ...
  Doctor_institutsCreateNestedManyWithoutInstituts_medicauxInput: ["create", "connectOrCreate", "createMany", "connect"],
  DoctorsCreateNestedManyWithoutInstitutsInput: ["create", "connectOrCreate", "connect"],
  ...
  Doctor_institutsUpdateManyWithoutInstituts_medicauxNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  DoctorsUpdateManyWithoutInstitutsNestedInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  Consultation_lab_requestsCreateNestedManyWithoutLab_requestsInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  Consultation_lab_requestsUpdateManyWithoutLab_requestsNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  ConsultationsCreateNestedManyWithoutPrescriptionsInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  ConsultationsUpdateManyWithoutPrescriptionsNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  Verification_tokensCreateNestedOneWithoutUserInput: ["create", "connectOrCreate", "connect"],
  DoctorsCreateNestedManyWithoutUsersInput: ["create", "connectOrCreate", "createMany", "connect"],
  PatientsCreateNestedManyWithoutUsersInput: ["create", "connectOrCreate", "createMany", "connect"],
  Enumusers_role_enumFieldUpdateOperationsInput: ["set"],
  Verification_tokensUpdateOneWithoutUserNestedInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  DoctorsUpdateManyWithoutUsersNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  PatientsUpdateManyWithoutUsersNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  UsersCreateNestedOneWithoutValidation_tokenInput: ["create", "connectOrCreate", "connect"],
  UsersUpdateOneRequiredWithoutValidation_tokenNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  DoctorsCreateNestedOneWithoutSentMessagesInput: ["create", "connectOrCreate", "connect"],
  DoctorsCreateNestedOneWithoutReceivedMessagesInput: ["create", "connectOrCreate", "connect"],
  MessageAttachmentCreateNestedManyWithoutMessageInput: ["create", "connectOrCreate", "createMany", "connect"],
  DoctorsUpdateOneRequiredWithoutSentMessagesNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  DoctorsUpdateOneRequiredWithoutReceivedMessagesNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  MessageAttachmentUpdateManyWithoutMessageNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  MessageCreateNestedOneWithoutAttachmentsInput: ["create", "connectOrCreate", "connect"],
  MessageUpdateOneRequiredWithoutAttachmentsNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  NestedEnumhopitaux_type_enumFilter: ["equals", "in", "notIn", "not"],
  NestedEnumhopitaux_type_enumWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  ...
  Instituts_medicauxCreateWithoutAuthorizationsInput: ["id", "type", "consultations", "doctor_instituts", "doctors"],
  ...
  Instituts_medicauxUpdateWithoutAuthorizationsInput: ["id", "type", "consultations", "doctor_instituts", "doctors"],
  ...
  DoctorsCreateWithoutCertificatesInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  ...
  DoctorsUpdateWithoutCertificatesInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  ...
  Lab_requestsCreateWithoutConsultation_lab_requestsInput: ["id", "type", "priority", "description", "lab_documents", "doctors", "patients", "consultations"],
  Lab_requestsCreateOrConnectWithoutConsultation_lab_requestsInput: ["where", "create"],
  ConsultationsCreateWithoutConsultation_lab_requestsInput: ["id", "section", "date", "notes", "measures", "prescriptions", "instituts_medicaux", "patients", "doctors", "rdvs", "lab_requests"],
  ConsultationsCreateOrConnectWithoutConsultation_lab_requestsInput: ["where", "create"],
  Lab_requestsUpsertWithoutConsultation_lab_requestsInput: ["update", "create", "where"],
  Lab_requestsUpdateToOneWithWhereWithoutConsultation_lab_requestsInput: ["where", "data"],
  Lab_requestsUpdateWithoutConsultation_lab_requestsInput: ["id", "type", "priority", "description", "lab_documents", "doctors", "patients", "consultations"],
  ConsultationsUpsertWithoutConsultation_lab_requestsInput: ["update", "create", "where"],
  ConsultationsUpdateToOneWithWhereWithoutConsultation_lab_requestsInput: ["where", "data"],
  ConsultationsUpdateWithoutConsultation_lab_requestsInput: ["id", "section", "date", "notes", "measures", "prescriptions", "instituts_medicaux", "patients", "doctors", "rdvs", "lab_requests"],
  Consultation_lab_requestsCreateWithoutConsultationsInput: ["lab_requests"],
  Consultation_lab_requestsCreateOrConnectWithoutConsultationsInput: ["where", "create"],
  Consultation_lab_requestsCreateManyConsultationsInputEnvelope: ["data", "skipDuplicates"],
  ...
  Instituts_medicauxCreateWithoutConsultationsInput: ["id", "type", "authorizations", "doctor_instituts", "doctors"],
  ...
  DoctorsCreateWithoutConsultationsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  ...
  Lab_requestsCreateWithoutConsultationsInput: ["id", "type", "priority", "description", "consultation_lab_requests", "lab_documents", "doctors", "patients"],
  Lab_requestsCreateOrConnectWithoutConsultationsInput: ["where", "create"],
  Consultation_lab_requestsUpsertWithWhereUniqueWithoutConsultationsInput: ["where", "update", "create"],
  Consultation_lab_requestsUpdateWithWhereUniqueWithoutConsultationsInput: ["where", "data"],
  Consultation_lab_requestsUpdateManyWithWhereWithoutConsultationsInput: ["where", "data"],
  Consultation_lab_requestsScalarWhereInput: ["AND", "OR", "NOT", "consultation_id", "lab_request_id"],
  ...
  Instituts_medicauxUpdateWithoutConsultationsInput: ["id", "type", "authorizations", "doctor_instituts", "doctors"],
  ...
  DoctorsUpdateWithoutConsultationsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  ...
  DoctorsCreateWithoutDoctor_institutsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  DoctorsCreateOrConnectWithoutDoctor_institutsInput: ["where", "create"],
  Instituts_medicauxCreateWithoutDoctor_institutsInput: ["id", "type", "authorizations", "consultations", "doctors"],
  Instituts_medicauxCreateOrConnectWithoutDoctor_institutsInput: ["where", "create"],
  DoctorsUpsertWithoutDoctor_institutsInput: ["update", "create", "where"],
  DoctorsUpdateToOneWithWhereWithoutDoctor_institutsInput: ["where", "data"],
  DoctorsUpdateWithoutDoctor_institutsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  Instituts_medicauxUpsertWithoutDoctor_institutsInput: ["update", "create", "where"],
  Instituts_medicauxUpdateToOneWithWhereWithoutDoctor_institutsInput: ["where", "data"],
  Instituts_medicauxUpdateWithoutDoctor_institutsInput: ["id", "type", "authorizations", "consultations", "doctors"],
  ...
  ConsultationsCreateWithoutDoctorsInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "prescriptions", "instituts_medicaux", "patients", "rdvs", "lab_requests"],
  ...
  Doctor_institutsCreateWithoutDoctorsInput: ["instituts_medicaux"],
  Doctor_institutsCreateOrConnectWithoutDoctorsInput: ["where", "create"],
  Doctor_institutsCreateManyDoctorsInputEnvelope: ["data", "skipDuplicates"],
  UsersCreateWithoutDoctorsInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "validation_token", "patients"],
  UsersCreateOrConnectWithoutDoctorsInput: ["where", "create"],
  Lab_requestsCreateWithoutDoctorsInput: ["id", "type", "priority", "description", "consultation_lab_requests", "lab_documents", "patients", "consultations"],
  ...
  MessageCreateWithoutSenderInput: ["id", "content", "createdAt", "updatedAt", "isRead", "patientId", "receiver", "attachments"],
  MessageCreateOrConnectWithoutSenderInput: ["where", "create"],
  MessageCreateManySenderInputEnvelope: ["data", "skipDuplicates"],
  MessageCreateWithoutReceiverInput: ["id", "content", "createdAt", "updatedAt", "isRead", "patientId", "sender", "attachments"],
  MessageCreateOrConnectWithoutReceiverInput: ["where", "create"],
  MessageCreateManyReceiverInputEnvelope: ["data", "skipDuplicates"],
  Instituts_medicauxCreateWithoutDoctorsInput: ["id", "type", "authorizations", "consultations", "doctor_instituts"],
  ...
  Doctor_institutsUpsertWithWhereUniqueWithoutDoctorsInput: ["where", "update", "create"],
  Doctor_institutsUpdateWithWhereUniqueWithoutDoctorsInput: ["where", "data"],
  Doctor_institutsUpdateManyWithWhereWithoutDoctorsInput: ["where", "data"],
  Doctor_institutsScalarWhereInput: ["AND", "OR", "NOT", "doctor_id", "institut_medical_id"],
  UsersUpsertWithoutDoctorsInput: ["update", "create", "where"],
  UsersUpdateToOneWithWhereWithoutDoctorsInput: ["where", "data"],
  UsersUpdateWithoutDoctorsInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "validation_token", "patients"],
  ...
  MessageScalarWhereInput: ["AND", "OR", "NOT", "id", "content", "createdAt", "updatedAt", "senderId", "receiverId", "isRead", "patientId"],
  MessageUpsertWithWhereUniqueWithoutReceiverInput: ["where", "update", "create"],
  MessageUpdateWithWhereUniqueWithoutReceiverInput: ["where", "data"],
  MessageUpdateManyWithWhereWithoutReceiverInput: ["where", "data"],
  ...
  ConsultationsCreateWithoutInstituts_medicauxInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "prescriptions", "patients", "doctors", "rdvs", "lab_requests"],
  ...
  Doctor_institutsCreateWithoutInstituts_medicauxInput: ["doctors"],
  Doctor_institutsCreateOrConnectWithoutInstituts_medicauxInput: ["where", "create"],
  Doctor_institutsCreateManyInstituts_medicauxInputEnvelope: ["data", "skipDuplicates"],
  DoctorsCreateWithoutInstitutsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages"],
  DoctorsCreateOrConnectWithoutInstitutsInput: ["where", "create"],
  ...
  Doctor_institutsUpsertWithWhereUniqueWithoutInstituts_medicauxInput: ["where", "update", "create"],
  Doctor_institutsUpdateWithWhereUniqueWithoutInstituts_medicauxInput: ["where", "data"],
  Doctor_institutsUpdateManyWithWhereWithoutInstituts_medicauxInput: ["where", "data"],
  DoctorsUpsertWithWhereUniqueWithoutInstitutsInput: ["where", "update", "create"],
  DoctorsUpdateWithWhereUniqueWithoutInstitutsInput: ["where", "data"],
  DoctorsUpdateManyWithWhereWithoutInstitutsInput: ["where", "data"],
  DoctorsScalarWhereInput: ["AND", "OR", "NOT", "id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "user_id"],
  ...
  Lab_requestsCreateWithoutLab_documentsInput: ["id", "type", "priority", "description", "consultation_lab_requests", "doctors", "patients", "consultations"],
  ...
  Lab_requestsUpdateWithoutLab_documentsInput: ["id", "type", "priority", "description", "consultation_lab_requests", "doctors", "patients", "consultations"],
  ...
  Consultation_lab_requestsCreateWithoutLab_requestsInput: ["consultations"],
  Consultation_lab_requestsCreateOrConnectWithoutLab_requestsInput: ["where", "create"],
  Consultation_lab_requestsCreateManyLab_requestsInputEnvelope: ["data", "skipDuplicates"],
  ...
  DoctorsCreateWithoutLab_requestsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  ...
  ConsultationsCreateWithoutLab_requestsInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "prescriptions", "instituts_medicaux", "patients", "doctors", "rdvs"],
  ConsultationsCreateOrConnectWithoutLab_requestsInput: ["where", "create"],
  Consultation_lab_requestsUpsertWithWhereUniqueWithoutLab_requestsInput: ["where", "update", "create"],
  Consultation_lab_requestsUpdateWithWhereUniqueWithoutLab_requestsInput: ["where", "data"],
  Consultation_lab_requestsUpdateManyWithWhereWithoutLab_requestsInput: ["where", "data"],
  ...
  DoctorsUpdateWithoutLab_requestsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  ...
  ConsultationsCreateWithoutPatientsInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "prescriptions", "instituts_medicaux", "doctors", "rdvs", "lab_requests"],
  ...
  Lab_requestsCreateWithoutPatientsInput: ["id", "type", "priority", "description", "consultation_lab_requests", "lab_documents", "doctors", "consultations"],
  ...
  UsersCreateWithoutPatientsInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "validation_token", "doctors"],
  ...
  UsersUpdateWithoutPatientsInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "validation_token", "doctors"],
  ...
  ConsultationsCreateWithoutPrescriptionsInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "instituts_medicaux", "patients", "doctors", "rdvs", "lab_requests"],
  ConsultationsCreateOrConnectWithoutPrescriptionsInput: ["where", "create"],
  ConsultationsCreateManyPrescriptionsInputEnvelope: ["data", "skipDuplicates"],
  ...
  DoctorsCreateWithoutPrescriptionsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  ...
  ConsultationsUpsertWithWhereUniqueWithoutPrescriptionsInput: ["where", "update", "create"],
  ConsultationsUpdateWithWhereUniqueWithoutPrescriptionsInput: ["where", "data"],
  ConsultationsUpdateManyWithWhereWithoutPrescriptionsInput: ["where", "data"],
  ...
  DoctorsUpdateWithoutPrescriptionsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  ...
  DoctorsCreateWithoutRdv_requestsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  ...
  DoctorsUpdateWithoutRdv_requestsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  ...
  ConsultationsCreateWithoutRdvsInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "prescriptions", "instituts_medicaux", "patients", "doctors", "lab_requests"],
  ...
  DoctorsCreateWithoutRdvsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "sentMessages", "receivedMessages", "instituts"],
  ...
  ConsultationsUpdateWithoutRdvsInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "prescriptions", "instituts_medicaux", "patients", "doctors", "lab_requests"],
  ...
  DoctorsUpdateWithoutRdvsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "sentMessages", "receivedMessages", "instituts"],
  Verification_tokensCreateWithoutUserInput: ["id", "token", "numberofTries", "createdAt", "expireAt"],
  Verification_tokensCreateOrConnectWithoutUserInput: ["where", "create"],
  DoctorsCreateWithoutUsersInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  DoctorsCreateOrConnectWithoutUsersInput: ["where", "create"],
  DoctorsCreateManyUsersInputEnvelope: ["data", "skipDuplicates"],
  ...
  PatientsCreateManyUsersInputEnvelope: ["data", "skipDuplicates"],
  Verification_tokensUpsertWithoutUserInput: ["update", "create", "where"],
  Verification_tokensUpdateToOneWithWhereWithoutUserInput: ["where", "data"],
  Verification_tokensUpdateWithoutUserInput: ["id", "token", "numberofTries", "createdAt", "expireAt"],
  DoctorsUpsertWithWhereUniqueWithoutUsersInput: ["where", "update", "create"],
  DoctorsUpdateWithWhereUniqueWithoutUsersInput: ["where", "data"],
  DoctorsUpdateManyWithWhereWithoutUsersInput: ["where", "data"],
  PatientsUpsertWithWhereUniqueWithoutUsersInput: ["where", "update", "create"],
  PatientsUpdateWithWhereUniqueWithoutUsersInput: ["where", "data"],
  PatientsUpdateManyWithWhereWithoutUsersInput: ["where", "data"],
  PatientsScalarWhereInput: ["AND", "OR", "NOT", "id", "cin", "date_of_birth", "gender", "profile_image", "general_medical_record_id", "user_id"],
  ...
  UsersCreateWithoutValidation_tokenInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "doctors", "patients"],
  UsersCreateOrConnectWithoutValidation_tokenInput: ["where", "create"],
  UsersUpsertWithoutValidation_tokenInput: ["update", "create", "where"],
  UsersUpdateToOneWithWhereWithoutValidation_tokenInput: ["where", "data"],
  UsersUpdateWithoutValidation_tokenInput: ["id", "address", "created_at", "email", "first_name", "last_name", "is_verified", "password", "salt", "last_login", "phone", "profile_picture", "role", "associated_id", "updated_at", "doctors", "patients"],
  DoctorsCreateWithoutSentMessagesInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "receivedMessages", "instituts"],
  DoctorsCreateOrConnectWithoutSentMessagesInput: ["where", "create"],
  DoctorsCreateWithoutReceivedMessagesInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "instituts"],
  DoctorsCreateOrConnectWithoutReceivedMessagesInput: ["where", "create"],
  MessageAttachmentCreateWithoutMessageInput: ["id", "filename", "path", "mimeType", "size", "createdAt"],
  MessageAttachmentCreateOrConnectWithoutMessageInput: ["where", "create"],
  MessageAttachmentCreateManyMessageInputEnvelope: ["data", "skipDuplicates"],
  DoctorsUpsertWithoutSentMessagesInput: ["update", "create", "where"],
  DoctorsUpdateToOneWithWhereWithoutSentMessagesInput: ["where", "data"],
  DoctorsUpdateWithoutSentMessagesInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "receivedMessages", "instituts"],
  DoctorsUpsertWithoutReceivedMessagesInput: ["update", "create", "where"],
  DoctorsUpdateToOneWithWhereWithoutReceivedMessagesInput: ["where", "data"],
  DoctorsUpdateWithoutReceivedMessagesInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "instituts"],
  MessageAttachmentUpsertWithWhereUniqueWithoutMessageInput: ["where", "update", "create"],
  MessageAttachmentUpdateWithWhereUniqueWithoutMessageInput: ["where", "data"],
  MessageAttachmentUpdateManyWithWhereWithoutMessageInput: ["where", "data"],
  MessageAttachmentScalarWhereInput: ["AND", "OR", "NOT", "id", "filename", "path", "mimeType", "size", "messageId", "createdAt"],
  MessageCreateWithoutAttachmentsInput: ["id", "content", "createdAt", "updatedAt", "isRead", "patientId", "sender", "receiver"],
  MessageCreateOrConnectWithoutAttachmentsInput: ["where", "create"],
  MessageUpsertWithoutAttachmentsInput: ["update", "create", "where"],
  MessageUpdateToOneWithWhereWithoutAttachmentsInput: ["where", "data"],
  MessageUpdateWithoutAttachmentsInput: ["id", "content", "createdAt", "updatedAt", "isRead", "patientId", "sender", "receiver"],
  Consultation_lab_requestsCreateManyConsultationsInput: ["lab_request_id"],
  Consultation_lab_requestsUpdateWithoutConsultationsInput: ["lab_requests"],
  Lab_requestsUpdateWithoutConsultationsInput: ["id", "type", "priority", "description", "consultation_lab_requests", "lab_documents", "doctors", "patients"],
  ...
  Doctor_institutsCreateManyDoctorsInput: ["institut_medical_id"],
  ...
  MessageCreateManySenderInput: ["id", "content", "createdAt", "updatedAt", "receiverId", "isRead", "patientId"],
  MessageCreateManyReceiverInput: ["id", "content", "createdAt", "updatedAt", "senderId", "isRead", "patientId"],
  CertificatesUpdateWithoutDoctorsInput: ["id", "type", "start_date", "end_date", "description", "patients"],
  ConsultationsUpdateWithoutDoctorsInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "prescriptions", "instituts_medicaux", "patients", "rdvs", "lab_requests"],
  Doctor_institutsUpdateWithoutDoctorsInput: ["instituts_medicaux"],
  Lab_requestsUpdateWithoutDoctorsInput: ["id", "type", "priority", "description", "consultation_lab_requests", "lab_documents", "patients", "consultations"],
  ...
  MessageUpdateWithoutSenderInput: ["id", "content", "createdAt", "updatedAt", "isRead", "patientId", "receiver", "attachments"],
  MessageUpdateWithoutReceiverInput: ["id", "content", "createdAt", "updatedAt", "isRead", "patientId", "sender", "attachments"],
  Instituts_medicauxUpdateWithoutDoctorsInput: ["id", "type", "authorizations", "consultations", "doctor_instituts"],
  ...
  Doctor_institutsCreateManyInstituts_medicauxInput: ["doctor_id"],
  AuthorizationsUpdateWithoutInstituts_medicauxInput: ["id", "level", "patients"],
  ConsultationsUpdateWithoutInstituts_medicauxInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "prescriptions", "patients", "doctors", "rdvs", "lab_requests"],
  Doctor_institutsUpdateWithoutInstituts_medicauxInput: ["doctors"],
  DoctorsUpdateWithoutInstitutsInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "users", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages"],
  ...
  Consultation_lab_requestsCreateManyLab_requestsInput: ["consultation_id"],
  ...
  Consultation_lab_requestsUpdateWithoutLab_requestsInput: ["consultations"],
  ...
  ConsultationsUpdateWithoutLab_requestsInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "prescriptions", "instituts_medicaux", "patients", "doctors", "rdvs"],
  ...
  ConsultationsUpdateWithoutPatientsInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "prescriptions", "instituts_medicaux", "doctors", "rdvs", "lab_requests"],
  ...
  Lab_requestsUpdateWithoutPatientsInput: ["id", "type", "priority", "description", "consultation_lab_requests", "lab_documents", "doctors", "consultations"],
  ...
  ConsultationsCreateManyPrescriptionsInput: ["id", "section", "date", "notes", "measures", "doctor_id", "institut_medical_id", "patient_id"],
  MedicationsCreateManyPrescriptionsInput: ["id", "dosage", "duration", "frequency", "name", "quantity"],
  ConsultationsUpdateWithoutPrescriptionsInput: ["id", "section", "date", "notes", "measures", "consultation_lab_requests", "instituts_medicaux", "patients", "doctors", "rdvs", "lab_requests"],
  MedicationsUpdateWithoutPrescriptionsInput: ["id", "dosage", "duration", "frequency", "name", "quantity"],
  DoctorsCreateManyUsersInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty"],
  PatientsCreateManyUsersInput: ["id", "cin", "date_of_birth", "gender", "profile_image", "general_medical_record_id"],
  DoctorsUpdateWithoutUsersInput: ["id", "type", "is_license_verified", "bio", "education", "experience", "first_name", "languages", "last_name", "profile_image", "specialty", "certificates", "consultations", "doctor_instituts", "lab_requests", "prescriptions", "rdv_requests", "rdvs", "sentMessages", "receivedMessages", "instituts"],
  ...
  MessageAttachmentCreateManyMessageInput: ["id", "filename", "path", "mimeType", "size", "createdAt"],
  MessageAttachmentUpdateWithoutMessageInput: ["id", "filename", "path", "mimeType", "size", "createdAt"]
};
