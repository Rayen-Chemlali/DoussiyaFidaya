...
@TypeGraphQL.InputType("MessageAttachmentOrderByWithRelationInput", {})
export class MessageAttachmentOrderByWithRelationInput {
  ...
  message?: MessageOrderByWithRelationInput | undefined;
}
